        ...
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-10 col-sm-12">
                    <form method="POST" action="{{ route('user.attributes.update', ['attribute' => $attribute->id]) }}" class="">
                        @csrf
                        @method('PUT')
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ __('backend.shared.delete-message', ['record_type' => __('backend.shared.city'), 'record_name' => $attribute->attribute_name]) }}
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ __('backend.shared.cancel') }}</button>
                    <form action="{{ route('user.attributes.destroy', ['attribute' => $attribute->id]) }}" method="POST">
                        @csrf
                        @method('DELETE')
