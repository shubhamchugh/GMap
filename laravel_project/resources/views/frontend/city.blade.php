                            ...
                            <div class="row justify-content-center mt-5">
                                <div class="col-md-8 text-center">
                                    <h1 style="color: {{ $site_innerpage_header_title_font_color }};">
                                        Pest Control Services In {{ $city->city_name }}, {{ $state->state_name }}</h1>
                                    {{-- <p class="mb-0" style="color: {{ $site_innerpage_header_paragraph_font_color }};">
                                    {{ __('frontend.city.description') }}</p> --}}
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb bg-white pl-0 pr-0">
                                                ...
                                                <li class="breadcrumb-item"><a
                                                        href="{{ route('page.state', $state->state_slug) }}">{{ $state->state_name }}</a>
                                                </li>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-12 text-left border-primary">
                                    <h2 class="font-weight-light text-primary">{{ $city->city_name }},
                                        {{ $state->state_name }}</h2>
                                </div>
                            </div>
                    ...
                    <div class="row mb-5">
                        <div class="col-md-7 text-left border-primary">
                            <h2 class="font-weight-light text-primary">
                                All Pest Control Services in {{ $state->state_name }} By City</h2>
                        </div>
                    </div>
                    <div class="row mt-5">
