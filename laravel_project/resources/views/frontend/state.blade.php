                        ...
                        <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="row justify-content-center mt-5">
                                <div class="col-md-8 text-center">
                                    <h1 style="color: {{ $site_innerpage_header_title_font_color }};"> Pest Control
                                        Services In {{ $state->state_name }}</h1>
                                    {{-- {{ __('frontend.state.title', ['state_name' => $state->state_name]) }}</h1>
                                    --}}
                                    {{-- <p class="mb-0" style="color: {{ $site_innerpage_header_paragraph_font_color }};">
                                    {{ __('frontend.state.description') }}</p> --}}
                                </div>
                            </div>
                    ...
                    <form method="GET" action="{{ route('page.state', ['state_slug' => $state->state_slug]) }}"
                        ...
                        <div class="row pt-3 pb-3 ml-1 mr-1 mb-5 rounded border">
                            <div class="col-12">
                                ...
                                <div class="row mb-5">
                                    @if($ad_before_breadcrumb->advertisement_alignment ==
                                ...
                                <div class="row mb-5">
                                    @if($ad_after_breadcrumb->advertisement_alignment ==
                                    \App\Advertisement::AD_ALIGNMENT_LEFT)
                                    <div class="col-12 text-left">
                                        <div>
                                ...
                                <div class="row">
                                    <div class="col-12 text-right">
                                        <a class="btn btn-sm btn-outline-primary rounded"
                                            href="{{ route('page.state', ['state_slug' => $state->state_slug]) }}">
                    ...
                    <div class="row mb-5">
                        <div class="col-md-7 text-left border-primary">
                            <h2 class="font-weight-light text-primary">
                                All Pest Control Services in {{ $state->state_name }} By Cities</h2>
                        </div>
                    </div>
                    <div class="row mt-5">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4 mb-3">
                            <a
                                href="{{ route('page.city', ['state_slug' => $state->state_slug, 'city_slug' => $item_city->city->city_slug]) }}">{{ $item_city->city->city_name }},
                                {{ $state->state_name }}</a>
                        </div>
                        @endforeach
