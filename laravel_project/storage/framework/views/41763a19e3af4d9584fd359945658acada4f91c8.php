                        ...
                        <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="row justify-content-center mt-5">
                                <div class="col-md-8 text-center">
                                    <h1 style="color: <?php echo e($site_innerpage_header_title_font_color); ?>;">
                                        Pest Control Services In <?php echo e($city->city_name); ?>, <?php echo e($state->state_name); ?></h1>
                                    ...
                                    <div class="col-md-12">
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb bg-white pl-0 pr-0">
                                                ...
                                                <li class="breadcrumb-item"><a
                                                        href="<?php echo e(route('page.state', $state->state_slug)); ?>"><?php echo e($state->state_name); ?></a>
                                                </li>
                                                <li class="breadcrumb-item active" aria-current="page">
                                                    <?php echo e($city->city_name); ?></li>
                                            </ol>
                                        </nav>
                                    </div>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-12 text-left border-primary">
                                    <h2 class="font-weight-light text-primary"><?php echo e($city->city_name); ?>,
                                        <?php echo e($state->state_name); ?></h2>
                                </div>
                            </div>
                    ...
                    <div class="row mb-5">
                        <div class="col-md-7 text-left border-primary">
                            <h2 class="font-weight-light text-primary">
                                All Pest Control Services in <?php echo e($state->state_name); ?> By City</h2>
                        </div>
                    </div>
                    <div class="row mt-5">
            ...
            <?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/runcloud/webapps/PestControlGoogleMap/laravel_project/resources/views/frontend/city.blade.php ENDPATH**/ ?>