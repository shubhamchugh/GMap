...
<div class="site-blocks-cover inner-page-cover overlay d-none d-xl-flex"
    style="background-image: url(https://s3.us-west-1.wasabisys.com/testa/blur/<?php echo e($item->item_image_blur); ?>);"
        ...
        <div class="container">
            <div class="row align-items-center item-blocks-cover">
                ...
                <div class="col-lg-2 col-md-2" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <img src="https://s3.us-west-1.wasabisys.com/testa/tiny/<?php echo e($item->item_image_tiny); ?>" alt="Image"
                        class="img-fluid rounded">
                    <?php elseif(!empty($item->item_image)): ?>
                    <img src="https://s3.us-west-1.wasabisys.com/testa/original/<?php echo e($item->item_image); ?>" alt="Image"
                        class="img-fluid rounded">
                    <?php else: ?>
                ...
                <div class="col-lg-3 col-md-5 pl-0 pr-0 item-cover-contact-section" data-aos="fade-up"
                    ...
                    <p>
                        ...
                        <a class="mr-1" href="<?php echo e($item->item_website); ?>" target="_blank"
    ...
    <div class="site-blocks-cover inner-page-cover overlay d-none d-md-flex d-lg-flex d-xl-none"
        style="background-image: url(<?php echo e(Storage::disk('public')->url('item/' . $item->item_image_blur)); ?>);"
        data-aos="fade" data-stellar-background-ratio="0.5">
        <?php else: ?>
        <div class="site-blocks-cover inner-page-cover overlay d-none d-md-flex d-lg-flex d-xl-none"
            style="background-image: url(<?php echo e(asset('frontend/images/placeholder/full_item_feature_image.webp')); ?>);"
            ...
            <div class="container">
                <div class="row align-items-center item-blocks-cover">
                    <div class="col-lg-2 col-md-3" data-aos="fade-up" data-aos-delay="400">
                        <?php if(!empty($item->item_image_tiny)): ?>
                        <img src="<?php echo e(Storage::disk('public')->url('item/' . $item->item_image_tiny)); ?>" alt="Image"
                            class="img-fluid rounded">
                        <?php elseif(!empty($item->item_image)): ?>
                        <img src="<?php echo e(Storage::disk('public')->url('item/' . $item->item_image)); ?>" alt="Image"
                            class="img-fluid rounded">
                        <?php else: ?>
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    ...
                                    <div id="item-image-gallery">
                                        ...
                                        <a href="https://s3.us-west-1.wasabisys.com/testa/gallery/<?php echo e($gallery->item_image_gallery_name); ?>"
                                            rel="item-image-gallery-thumb">
                                            <img alt="Image"
                                                src="https://s3.us-west-1.wasabisys.com/testa/galleryThumbnail/<?php echo e($gallery->item_image_gallery_name); ?>" />
                                        </a>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                    <?php else: ?>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <img src="<?php echo e(asset('frontend/images/placeholder/full_item_feature_image.webp')); ?>"
                                            alt="Image" class="img-fluid rounded">
                                        <?php else: ?>
                                        <img src="<?php echo e(Storage::disk('public')->url('item/' . $item->item_image)); ?>"
                                            alt="Image" class="img-fluid rounded">
                                        <?php endif; ?>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="row align-items-center mb-3">
                                                <div class="col-4">
                                                    ...
                                                    <?php else: ?>
                                                    <img src="https://s3.us-west-1.wasabisys.com/testa/profile/<?php echo e(\App\User::find($review->author_id)->user_image); ?>"
                            ...
                            <div class="pt-3">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-4">
                                        ...
                                        <img src="https://s3.us-west-1.wasabisys.com/testa/profile/<?php echo e($item->user->user_image); ?>"
                                            alt="Image" class="img-fluid rounded-circle">
                                        <?php else: ?>
                                ...
                                <div class="lh-content">
                                    ...
                                    <div class="row">
                                        <div class="col-2 pr-0">
                                            ...
                                            <img src="https://s3.us-west-1.wasabisys.com/testa/profile/<?php echo e($similar_item->user->user_image); ?>"
                                        ...
                                        <div class="col-10 line-height-1-2">
                                            ...
                                            <div class="row line-height-1-0">
                                                <div class="col-12">
                                                    ...
                                                    <?php endif; ?>
                                                    <span
                                                        class="review"><?php echo e($similar_item->created_at->diffForHumans()); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="lh-content">
                                    ...
                                    <div class="row">
                                        <div class="col-2 pr-0">
                                            ...
                                            <img src="https://s3.us-west-1.wasabisys.com/testa/profile/<?php echo e($nearby_item->user->user_image); ?>"
                                        ...
                                        <div class="col-10 line-height-1-2">
                                            ...
                                            <div class="row line-height-1-0">
                                                <div class="col-12">
                                                    ...
                                                    <span
                                                        class="review"><?php echo e($nearby_item->totalComments() . ' comment'); ?></span>
                                                    <?php endif; ?>
                                                    <span
                                                        class="review"><?php echo e($nearby_item->created_at->diffForHumans()); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    value="<?php echo e(old('item_share_email_name')); ?>"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <form
                                        action="<?php echo e(route('page.item.lead.store', ['item_slug' => $item->item_slug])); ?>"
                                        method="POST">
                                        <?php echo csrf_field(); ?>
                                        <div class="form-row mb-3">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-row mb-3">
                                            <div class="col-md-12">
                                                ...
                                                <textarea
                                                    class="form-control <?php $__errorArgs = ['item_lead_message'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        function initMap() {
            ...
            <?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/googlemap/laravel_project/resources/views/frontend/item.blade.php ENDPATH**/ ?>